...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  array (
    ...
    array (
      0 => 'C:\\laragon\\www\\simpleEfficient\\Resources\\Views\\Admin\\login.html',
      1 => 1547803544,
      2 => 'file',
    ),
  ),
                    ...
                    <div class="panel-body" style="padding:30px;">
                        ...
                        <div class="form-group">
                            <div class="field">
                                ...
                                <img src="index.php?p=Back&c=Admin&a=captcha"
                                     onclick="this.src='index.php?p=Back&c=Admin&a=captcha&n='+Math.random()" width="80" height="32" class="passcode" />
                            </div>
                        </div>
                    </div>
